...
public class MultiuserTracking extends AppCompatActivity implements OnMapReadyCallback
    ...
    private static final float OFFICE_ATTENDENCE_RADIOUS = 100;
    ...
    private String mTime, mName, mClientImage;
...
//        clientLocation.setLongitude(Double.parseDouble("77.297800"));
        ...
        onPermissionListener = new PermissionListener() {
            ...
            public void onPermissionGranted() {
                if (ActivityCompat.checkSelfPermission(MultiuserTracking.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(MultiuserTracking.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                    return;
                }
            ...
            public void onPermissionDenied(ArrayList<String> deniedPermissions) {
                Toast.makeText(MultiuserTracking.this, "Permission Denied\n" + deniedPermissions.toString(), Toast.LENGTH_SHORT).show();
            }
        };
        InitUI();
    }
...
//            updateLocationUI();
    ...
    protected void onStart() {
        ...
        if (setLocation != null) {
            setLocation.onAttach(MultiuserTracking.this);
        }
    }
    ...
    public void onResult(LocationSettingsResult locationSettingsResult) {
        ...
        switch (status.getStatusCode()) {
            ...
            case LocationSettingsStatusCodes.RESOLUTION_REQUIRED: // show gps enable dialog
                try {
                    status.startResolutionForResult(MultiuserTracking.this, REQUEST_CHECK_SETTINGS);
    ...
    public void onLocationChanged(Location location) {
        ...
        AppUser.setMyLatLng(MultiuserTracking.this, location);
//        mLastUpdateTime = DateFormat.getTimeInstance().format(new Date());
        mLastUpdateDate = DateTimeUtility.getDateStampFormatted();
        mLastUpdateTime = DateTimeUtility.getTimeStampFormatted();
        AppUser.setLastLocationDate(MultiuserTracking.this, mLastUpdateDate);
        AppUser.setLastLocationTime(MultiuserTracking.this, mLastUpdateTime);
...
//        addOfficeMarkerLocationOnMap(clientLocation,"Gennext",true);
        if (mCurrentLocation != null) {
            ...
            focusOnLocation(AppUser.getMyLocation(MultiuserTracking.this), zoomAnimation);
        }
    }
...
//                mLastUpdateTime = DateTimeUtility.getTimeStampFormatted();
//                if (mCurrentLocation != null) {
//                    AppUser.setMyLatLng(MultiuserTracking.this, mCurrentLocation);
//                }
//                updateLocationUI(true);
            }
        });

        MapStyleOptions style = MapStyleOptions.loadRawResourceStyle(MultiuserTracking.this, R.raw.custom_map_style);
//        map.setMapStyle(style);
        ...
        if (ActivityCompat.checkSelfPermission(MultiuserTracking.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(MultiuserTracking.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            // TODO: Consider calling
            new TedPermission(MultiuserTracking.this)
...
//    }
    ...
    public void allocateMarkersOnCurrentLocation(Location location) {
        ...
        if (DataList != null && DataList.size() > 0) {
            for (Getseter model : DataList) {
                MarkerOptions clientMarker = new MarkerOptions();
                mClientView = getClientView(this,model.getID(), model.getUdate());
...
//        userMarker.icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_AZURE));
                ...
                LatLng clientLatLng = new LatLng(Utils.parseDouble(model.getCount()), Utils.parseDouble(model.getImg()));
                builder.include(clientLatLng);
                // add marker to Map
                map.addMarker(clientMarker
//                        .title(model.getID() != null ? model.getID() : "User")
...
//            ivClientMarker.setImageURI(Uri.parse(imageClient));
    ...
    public void updateRadiusInMapView(int progress) {
        ...
        if (mCurrentLocation == null) {
            mCurrentLocation = AppUser.getMyLocation(MultiuserTracking.this);
        }
    }

    private void executeTask(String entryType, String date, String timeInOut, String location, int errorCount) {
//        assignTask = new AssignTask(MultiuserTracking.this, entryType, valString(date), valString(timeInOut), location, errorCount);
...
//                    ApiCallError.newInstance(true, result.getOutput(), result.getOutputMsg(), errorCount, errorSoon, MultiuserTracking.this)
...
//                            arr.add(new Getseter(jsonObject1.optString("latitude"));
                        ...
                        if (DataList != null && DataList.size() != 0 && mCurrentLocation != null) {
                            allocateMarkersOnCurrentLocation(mCurrentLocation);
                        }
